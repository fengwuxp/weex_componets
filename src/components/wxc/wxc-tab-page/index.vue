...
<template>
    <div class="wxc-tab-page">
        <scroller class="tab-title-list"
                  ...
                  :data-spm="spmC"
                  :style="{ backgroundColor: tabStyles.bgColor,
                           height: (tabStyles.height)+'px',paddingLeft:tabStyles.leftOffset+'px',
                           borderBottomWidth:1,
        ...
        <div class="tab-page-wrap"
            ...
            <div ref="tab-container"
                 class="tab-container" :style="{width:750*tabTitles.length}">
                <slot></slot>
            </div>
        </div>
    </div>
